...
export default class AllTripPlan extends Component {
    constructor(props) {
        super(props);
        this.state = {
            data: [{
                avata: require('../../Resource/TripPlan/nesta/nesta_avata.jpg'), scenery: require('../../Resource/TripPlan/nesta/nesta.png'),
            ...
            {
                avata: require('../../Resource/TripPlan/maldini/maldini_avata.jpg'), scenery: require('../../Resource/TripPlan/maldini/maldini.png'),
                ...
                avata: require('../../Resource/TripPlan/stam/stam_avata.jpg'), scenery: require('../../Resource/TripPlan/stam/stamp.png'),
                timeupdate: '3 hours ago',
                from: 'Hà Nội',
                to: 'Hà Lan',
                sumday: 3,
                name:'Jaap Stam'
