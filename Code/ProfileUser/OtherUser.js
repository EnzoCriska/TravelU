...
export default class OtherUser extends Component {
    constructor(props){
        ...
        this.state = {
            isFollowed: true,
            userID: 'Hinata',
            avatarImg: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQJ7BAFar5vI8wLh7q7rY4aQZMm42FKou8dFEFUwZQ5sUyrdImi',
            coverImg: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQbFHPGO-JO8JaskF6B_Tu8yumvOPjLxOIQ3KQG8mFViBuphU9_',
            follower: 125,
            following:150,
            review:321,
            photos:12,
            ...
            posts:[
                {   
                    userPost: "Hinata",
                    avatarUserPost:'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQJ7BAFar5vI8wLh7q7rY4aQZMm42FKou8dFEFUwZQ5sUyrdImi',
    ...
    renderFollowButton(){
        if (this.state.isFollowed){
            return (
                <Image
                    source={require('../../Resource/ProfileUser/MyProfile/Following.png')}
            ...
            return(
                <Image
                    source={require('../../Resource/ProfileUser/MyProfile/follow.png')}
