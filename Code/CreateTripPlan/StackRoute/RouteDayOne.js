            ...
            <View style={styles.container}>
                ...
                <View style={styles.viewTitle}>
                    ...
                    <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center' }}>
                        ...
                        <Text>{this.state.data.sumKm}</Text>
                    </View>
                    <View style={{ flex: 1, justifyContent: 'center', alignItems: 'flex-end' }}>
                        <Text style={styles.textBlack}> Số địa điểm</Text>
                        <Text>{this.state.data.sumPlace}</Text>
                    </View>
                </View>
                {/* End View Logo */}
                ...
                <View style={{ width: '100%' }}>
                    ...
                    <Image source={require('../../../Resource/StackRoute/RouteDay1/point.png')} style={[styles.iconPoint,{marginTop:30}]}></Image>
                    <Image source={require('../../../Resource/StackRoute/RouteDay1/line.png')} style={styles.iconLine}></Image>
                    </View>
                    <View style={{width:'85%', marginLeft: 'auto', marginRight: '5%'}}>
                        <View style={styles.viewItem}>
                            <View style={{ flexDirection: 'row', width: '100%' }}>
                                <Image source={this.state.data.Hotels.image} style={styles.imageInView}></Image>
                                <View style={{ marginLeft: 10, marginTop: 5 }}>
                                    <Text style={{ color: 'black', fontSize: 15 }}>{this.state.data.Hotels.name}</Text>
                                    <View style={{ flexDirection: 'row', justifyContent: 'center', alignItems: 'center' }}>
                                        ...
                                        />
                                        <Text style={{ fontSize: 12 }}>  ( {this.state.data.Hotels.vote} đánh giá )</Text></View>

                                    <View>
                                        <View style={{ flexDirection: 'row' }}>
                                            <Text style={{ fontSize: 12 }}>Hotel star {this.state.data.Hotels.hotelstar}</Text>
                                            <Image source={require('../../../Resource/StackRoute/RouteDay1/star.png')}
                                ...
                                <TouchableOpacity style={{ marginLeft: 'auto' }}>
                                    <Image source={require('../../../Resource/StackRoute/RouteDay1/trash.png')} style={styles.iconTrash}></Image>
                                </TouchableOpacity>
                            </View>
                            <View style={{ width: '100%', flexDirection: 'row' }}>
                                <TouchableOpacity>
                                    <ImageBackground source={require('../../../Resource/StackRoute/RouteDay1/button_clock.png')}
                                        style={styles.buttonInItem}>
                                        <Text style={styles.textInButton}>{this.state.data.Hotels.clock} </Text>
                                    </ImageBackground>
                                </TouchableOpacity>
                                <TouchableOpacity>
                                    <ImageBackground source={require('../../../Resource/StackRoute/RouteDay1/button_note.png')}
                                ...
                                <TouchableOpacity style={{ marginLeft: 'auto' }}>
                                    <Image source={require('../../../Resource/StackRoute/RouteDay1/button_book.png')}
                    ...
                    <FlatList
                        ...
                        renderItem={({ item }) => (
                            ...
                            <View style={{ alignItems: 'center', height: 140, justifyContent: 'center', width:'10%', marginTop:-50}}>
                                <Image style={styles.iconLine} source={require('../../../Resource/StackRoute/RouteDay1/line.png')} />
                                <Image style={styles.iconOto} source={require('../../../Resource/StackRoute/RouteDay1/oto.png')} />
                                <Image style={styles.iconLineShort} source={require('../../../Resource/StackRoute/RouteDay1/lineshort.png')} />
                                <Image source={require('../../../Resource/StackRoute/RouteDay1/point.png')} style={[styles.iconPoint]} />
                            ...
                            <View style={{ width: '85%', marginRight: '5%', height: 120, marginTop: 20, marginLeft: 'auto' }}>
                                <Text style={styles.textMinAndLong}>{item.long} km | {item.time} mins</Text>
                                <View style={{ flexDirection: 'row', width: '100%' }}>
                                    <Image source={item.image} style={styles.imageInView}></Image>
                                    <View style={{ marginLeft: 10, marginTop: 5 }}>
